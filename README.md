...
`[screenshots/dashboard3_reaction_outcome.png]`

> Replace the bracketed paths above with real image links once screenshots are added to a `/screenshots` folder in this repository, e.g.:
> `![Dashboard 1](screenshots/dashboard1_demographics_reporting.png)`

**Live Tableau Public workbook:** `[Add your published Tableau Public link here]`
